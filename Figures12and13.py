...
for i in range(0,2*max_nodes+1):
    coalescence_moments.append(helpers.extract_analytic_moment(coalescence_func, 0, 250., i))
...
for i in range(0,2*max_nodes+1):
    condensation_moments.append(helpers.extract_analytic_moment(condensation_func, 0, 80, i))
